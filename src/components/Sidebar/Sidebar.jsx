    ...
    <div className="sidebar">
      ...
      <div className="bottom-pane">
        <div className="skills">
          ...
          <span style={{ color: "white" }}>NEXT JS</span>
          <ProgressBar striped animated variant="secondary" now={80} />
        </div>
        <div className="lang">
      ...
      <div className="social">
        <a href="https://www.linkedin.com/in/habib-tanwir/" target="_blank" rel="noreferrer">
          <LinkedInIcon />
        </a>
